...
epsilonvarHP8, = ax12.plot(time, varHP8_sampled_LR_mean, label=f'Humans and pigeon - 8 options', color='#60460f',linewidth=1)
ax12.fill_between(time, varHP8_sampled_LR_mean - varHP8_sampled_LR_ste, varHP8_sampled_LR_mean + varHP8_sampled_LR_ste, color='#60460f', alpha=0.2)

epsilonvarHP4, = ax12.plot(time, varHP4_sampled_LR_mean, label=f'Humans and pigeon - 4 options', color='#af6f09',linewidth=1)
ax12.fill_between(time, varHP4_sampled_LR_mean - varHP4_sampled_LR_ste, varHP4_sampled_LR_mean + varHP4_sampled_LR_ste, color='#af6f09', alpha=0.2)

epsilonvarHP2, = ax12.plot(time, varHP2_sampled_LR_mean, label=f'Humans and pigeon - 2 options', color='#b2996e',linewidth=1)
ax12.fill_between(time, varHP2_sampled_LR_mean - varHP2_sampled_LR_ste, varHP2_sampled_LR_mean + varHP2_sampled_LR_ste, color='#b2996e', alpha=0.2)
