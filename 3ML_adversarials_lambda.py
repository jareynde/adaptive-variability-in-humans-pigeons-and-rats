...
#for time plot:
varHAS_sampled_lambda_mean = np.mean(g_varHAS, axis=0) #this is the mean of the sampled lambda
varHAS_sampled_lambda_std = np.std(g_varHAS, axis=0) #this is the std of the sampled lambda
...
#for time plot:
varHP8_sampled_lambda_mean = np.mean(g_varHP8, axis=0) #this is the mean of the sampled lambda
varHP8_sampled_lambda_std = np.std(g_varHP8, axis=0) #this is the std of the sampled lambda
...
#for time plot:
varHP4_sampled_lambda_mean = np.mean(g_varHP4, axis=0) #this is the mean of the sampled lambda
varHP4_sampled_lambda_std = np.std(g_varHP4, axis=0) #this is the std of the sampled lambda
...
#for time plot:
varHP2_sampled_lambda_mean = np.mean(g_varHP2, axis=0) #this is the mean of the sampled lambda
varHP2_sampled_lambda_std = np.std(g_varHP2, axis=0) #this is the std of the sampled lambda
...
#for time plot:
RAT_sampled_lambda_mean = np.mean(g_RAT, axis=0) #this is the mean of the sampled lambda
RAT_sampled_lambda_std = np.std(g_RAT, axis=0) #this is the std of the sampled lambda
...
epsilonvarHP8, = ax12.plot(time, varHP8_sampled_lambda_mean, label=f'Humans and pigeon - 8 options', color='#60460f',linewidth=1)
ax12.fill_between(time, varHP8_sampled_lambda_mean - varHP8_sampled_lambda_ste, varHP8_sampled_lambda_mean + varHP8_sampled_lambda_ste, color='#60460f', alpha=0.2)

epsilonvarHP4, = ax12.plot(time, varHP4_sampled_lambda_mean, label=f'Humans and pigeon - 4 options', color='#af6f09',linewidth=1)
ax12.fill_between(time, varHP4_sampled_lambda_mean - varHP4_sampled_lambda_ste, varHP4_sampled_lambda_mean + varHP4_sampled_lambda_ste, color='#af6f09', alpha=0.2)

epsilonvarHP2, = ax12.plot(time, varHP2_sampled_lambda_mean, label=f'Humans and pigeon - 2 options', color='#b2996e',linewidth=1)
ax12.fill_between(time, varHP2_sampled_lambda_mean - varHP2_sampled_lambda_ste, varHP2_sampled_lambda_mean + varHP2_sampled_lambda_ste, color='#b2996e', alpha=0.2)
