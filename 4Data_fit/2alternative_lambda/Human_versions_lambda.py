...
def negll_4RW_eps_alpha_uc(params, k, r):
    ...
    for t in range(T):
        ...
        F_k[k[t]] = F_k[k[t]] - unchosen*(1-F_k[k[t]]) #subtract previous line from chosen action update
        F_k[k[t]] = F_k[k[t]] - unchosen*(0-F_k[k[t]]) #add correct update for chosen action
...
data_unchosen2 = np.zeros(18, dtype=float)
data_weight2 = np.zeros(18, dtype=float)
data_BIC2 = np.zeros(18, dtype=float)
data_negLL2 = np.zeros(18, dtype=float)
data_trials2 = np.zeros(18, dtype=float)

results3 = {}
data_eps3 = np.zeros(18, dtype=float)
data_alpha3 = np.zeros(18, dtype=float)
data_unchosen3 = np.zeros(18, dtype=float)
data_BIC3 = np.zeros(18, dtype=float)
data_negLL3 = np.zeros(18, dtype=float)
data_trials3 = np.zeros(18, dtype=float)


results4 = {}
data_eps4 = np.zeros(18, dtype=float)
data_alpha4 = np.zeros(18, dtype=float)
data_unchosen4 = np.zeros(18, dtype=float)
data_weight4 = np.zeros(18, dtype=float)
data_BIC4 = np.zeros(18, dtype=float)
data_negLL4 = np.zeros(18, dtype=float)
data_trials4 = np.zeros(18, dtype=float)
...
results5 = {}
data_eps5 = np.zeros(18, dtype=float)
data_alpha5 = np.zeros(18, dtype=float)
data_weight5 = np.zeros(18, dtype=float)
data_BIC5 = np.zeros(18, dtype=float)
data_negLL5 = np.zeros(18, dtype=float)
data_trials5 = np.zeros(18, dtype=float)


results6 = {}
data_eps6 = np.zeros(18, dtype=float)
data_alpha6 = np.zeros(18, dtype=float)
data_BIC6 = np.zeros(18, dtype=float)
data_negLL6 = np.zeros(18, dtype=float)
data_trials6 = np.zeros(18, dtype=float)


results7 = {}
data_eps7 = np.zeros(18, dtype=float)
data_alpha7 = np.zeros(18, dtype=float)
data_weight7 = np.zeros(18, dtype=float)
data_BIC7 = np.zeros(18, dtype=float)
data_negLL7 = np.zeros(18, dtype=float)
data_trials7 = np.zeros(18, dtype=float)


results8 = {}
data_eps8 = np.zeros(18, dtype=float)
data_alpha8 = np.zeros(18, dtype=float)
data_BIC8 = np.zeros(18, dtype=float)
data_negLL8 = np.zeros(18, dtype=float)
data_trials8 = np.zeros(18, dtype=float)
...
results9 = {}
data_eps9 = np.zeros(18, dtype=float)
data_alpha9 = np.zeros(18, dtype=float)
data_unchosen9 = np.zeros(18, dtype=float)
data_weight9 = np.zeros(18, dtype=float)
data_BIC9 = np.zeros(18, dtype=float)
data_negLL9 = np.zeros(18, dtype=float)
data_trials9 = np.zeros(18, dtype=float)

results10 = {}
data_eps10 = np.zeros(18, dtype=float)
data_alpha10 = np.zeros(18, dtype=float)
data_unchosen10 = np.zeros(18, dtype=float)
data_weight10 = np.zeros(18, dtype=float)
data_BIC10 = np.zeros(18, dtype=float)
data_negLL10 = np.zeros(18, dtype=float)
data_trials10 = np.zeros(18, dtype=float)


results11 = {}
data_eps11 = np.zeros(18, dtype=float)
data_alpha11 = np.zeros(18, dtype=float)
data_unchosen11 = np.zeros(18, dtype=float)
data_weight11 = np.zeros(18, dtype=float)
data_BIC11 = np.zeros(18, dtype=float)
data_negLL11 = np.zeros(18, dtype=float)
data_trials11 = np.zeros(18, dtype=float)

results12 = {}
data_eps12 = np.zeros(18, dtype=float)
data_alpha12 = np.zeros(18, dtype=float)
data_weight12 = np.zeros(18, dtype=float)
data_BIC12 = np.zeros(18, dtype=float)
data_negLL12 = np.zeros(18, dtype=float)
data_trials12 = np.zeros(18, dtype=float)
...
save_dir = os.path.join(data_dir1, 'Human_output_versions_lambda')
dict_name = f'10Human_RW_uc_weight.xlsx'
...
dict_name = f'1Human_eps-alpha-uc.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results1)
df.to_excel(dict_save)


dict_name = f'2Human_seperate_uc_weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results2)
df.to_excel(dict_save)

dict_name = f'3Human_seperate_uc_noweight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results3)
df.to_excel(dict_save)

dict_name = f'4Human_RW_uc_weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
...
dict_name = f'5Human_eps-alpha-posuc-weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results5)
df.to_excel(dict_save)

dict_name = f'6Human_eps-alpha-posuc.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results6)
df.to_excel(dict_save)

dict_name = f'7Human_eps-alpha-neguc-weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results7)
df.to_excel(dict_save)

dict_name = f'8Human_eps-alpha-neguc.xlsx'
dict_save = os.path.join(save_dir,dict_name)
...
dict_name = f'9Human_seperate_uc_weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
...
dict_name = f'11Human_eps-alpha-posuc-weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
df = pd.DataFrame(data=results11)
df.to_excel(dict_save)


dict_name = f'12Human_eps-alpha-neguc-weight.xlsx'
dict_save = os.path.join(save_dir,dict_name)
