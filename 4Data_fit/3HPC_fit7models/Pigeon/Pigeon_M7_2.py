...
for s in range(len(files)):
    ...
    line_to_write = {"sub": data_sub[s], "eps": data_eps72[s], "alpha": data_alpha72[s], "lambda" : data_unchosen72[s], "lambda_s" : data_unchosenseq72[s], "w": data_weight72[s], "gamnr": data_gamnonr72[s], "BIC": data_BIC72[s], "negLL": data_negLL72[s], "trials": data_trials72[s], "choices": choices[s]}
    with open("Pigeon_M7_2.csv", 'a') as f_object:
