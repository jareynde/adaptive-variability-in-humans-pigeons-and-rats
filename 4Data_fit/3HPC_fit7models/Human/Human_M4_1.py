...
for s in range(len(files)):
    ...
    line_to_write = {"sub": data_sub[s], "eps": data_eps41[s], "alpha": data_alpha41[s], "lambda": data_unchosen41[s], "gamr": data_gamr41[s], "BIC": data_BIC41[s], "negLL": data_negLL41[s], "trials": data_trials41[s], "choices": choices[s]}
    with open("Human_M4_1.csv", 'a') as f_object:
