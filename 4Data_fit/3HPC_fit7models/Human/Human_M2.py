...
for s in range(len(files)):
    ...
    line_to_write = {"sub": data_sub[s], "eps": data_eps2[s], "alpha": data_alpha2[s],"lambda": data_unchosen2[s], "BIC": data_BIC2[s], "negLL": data_negLL2[s], "trials": data_trials2[s], "choices": choices[s]}
    with open("Human_M2.csv", 'a') as f_object:
