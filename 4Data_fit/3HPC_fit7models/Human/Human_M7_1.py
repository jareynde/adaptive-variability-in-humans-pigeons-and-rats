...
for s in range(len(files)):
    ...
    line_to_write = {"sub": data_sub[s], "eps": data_eps71[s], "alpha": data_alpha71[s], "lambda": data_unchosen71[s], "lambda_s" : data_unchosenseq71[s], "w": data_weight71[s], "gamr": data_gamr71[s], "BIC": data_BIC71[s], "negLL": data_negLL71[s], "trials": data_trials71[s], "choices": choices[s]}
    with open("Human_M7_1.csv", 'a') as f_object:
        field_names = ["sub", "eps", "alpha", "lambda", "lambda_s", "w", "gamr", "BIC", "negLL", "trials", "choices"]
