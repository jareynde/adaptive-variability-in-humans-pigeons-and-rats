...
results32 = {}
data_eps32 = np.zeros(18, dtype=float)
data_alpha32 = np.zeros(18, dtype=float)
data_gamnonr32 = np.zeros(18, dtype=float)
data_BIC32 = np.zeros(18, dtype=float)
data_negLL32 = np.zeros(18, dtype=float)
data_trials32 = np.zeros(18, dtype=float)



#    model 4.1  eps, lr, uc, gamr = params
results41 = {}
data_eps41 = np.zeros(18, dtype=float)
data_alpha41 = np.zeros(18, dtype=float)
data_unchosen41 = np.zeros(18, dtype=float)
data_gamr41 = np.zeros(18, dtype=float)
data_BIC41 = np.zeros(18, dtype=float)
data_negLL41 = np.zeros(18, dtype=float)
data_trials41 = np.zeros(18, dtype=float)

#   model 4.2  eps, lr, uc, gamnr = params
results42 = {}
data_eps42 = np.zeros(18, dtype=float)
data_alpha42 = np.zeros(18, dtype=float)
data_unchosen42 = np.zeros(18, dtype=float)
data_gamnonr42 = np.zeros(18, dtype=float)
data_BIC42 = np.zeros(18, dtype=float)
data_negLL42 = np.zeros(18, dtype=float)
data_trials42 = np.zeros(18, dtype=float)
...
data_unchosen5 = np.zeros(18, dtype=float)
data_unchosenseq5 = np.zeros(18,dtype=float)
...
results71 = {}
data_eps71 = np.zeros(18, dtype=float)
data_alpha71 = np.zeros(18, dtype=float)
data_unchosen71 = np.zeros(18, dtype=float)
data_unchosenseq71 = np.zeros(18,dtype=float)
data_weight71 = np.zeros(18, dtype=float)
data_gamr71 = np.zeros(18, dtype=float)
data_BIC71 = np.zeros(18, dtype=float)
data_negLL71 = np.zeros(18, dtype=float)
data_trials71 = np.zeros(18, dtype=float)
...
for s in range(len(files)):
    ...
    with open("Human_M1.csv", 'a') as f_object:
