...
for count, folder in enumerate(maps):
    ...
    for file_name in subj_data_list:
        ...
        all_eps1 = np.append(all_eps1, param_fits1[0])
        all_unchosen1 = np.append(all_unchosen1, param_fits1[1])
        ...
        sub_eps1 = np.append(sub_eps1, param_fits1[0])
        sub_unchosen1 = np.append(sub_unchosen1, param_fits1[1])
