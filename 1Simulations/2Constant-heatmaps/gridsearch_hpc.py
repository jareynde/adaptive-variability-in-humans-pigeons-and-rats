...
# -*- coding: utf-8 -*-
"""
Same as 2Constant_gridsearch.py script in Project1
...
This script is adapted to run on the HPC cluster
...
all_unchosen = np.linspace(-1/K, 1/K, heat, endpoint=True)
...
"eps": eps,
"alpha": 0,
**{str(i+1): all_unchosen[i] for i in range(51)}}


with open(f"reward/mr_var_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
...
with open(f"reward/mr_vol_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"reward/mr_sta_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"reward/er_var_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"reward/er_vol_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"reward/er_sta_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"entropy/mu_var_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"entropy/mu_vol_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"entropy/mu_sta_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"entropy/eu_var_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"entropy/eu_vol_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
with open(f"entropy/eu_sta_eps{epsint}.csv", 'a') as f_object:
    field_names = ["sim", "eps", "alpha"] + [str(i) for i in range(1, 52)]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()
...
for j in range(heat): # vary learning rate, row per row
    for k in range(heat): #vary lambda, column per column
        done = done
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): mr_varheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): mr_volheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): mr_staheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): er_varheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): er_volheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): er_staheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): mu_varheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): mu_volheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): mu_staheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): eu_varheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): eu_volheat[j, i] for i in range(51)}}
    ...
    "eps": eps,
    "alpha": Q_alpha,
    **{str(i+1): eu_staheat[j, i] for i in range(51)}}
...
fig_name = os.path.join(save_dir1, f'adv_mr_2eps{i}.jpeg')
...
fig_name = os.path.join(save_dir1, f'sta_mr_2eps{i}.jpeg')
plt.savefig(fig_name)
...
fig_name = os.path.join(save_dir1, f'vol_mr_2eps{i}.jpeg')
plt.savefig(fig_name)
...
df_mu_varheat.to_excel(os.path.join(save_dir2, f'adv_mu_2eps{i}.xlsx'))

df_mu_staheat = pd.DataFrame(mu_staheat)
df_mu_staheat.to_excel(os.path.join(save_dir2, f'sta_mu_2eps{i}.xlsx'))

df_mu_volheat = pd.DataFrame(mu_volheat)
df_mu_volheat.to_excel(os.path.join(save_dir2, f'vol_mu_2eps{i}.xlsx'))



df_eu_varheat = pd.DataFrame(eu_varheat)
df_eu_varheat.to_excel(os.path.join(save_dir2, f'adv_eu_2eps{i}.xlsx'))

df_eu_staheat = pd.DataFrame(eu_staheat)
df_eu_staheat.to_excel(os.path.join(save_dir2, f'sta_eu_2eps{i}.xlsx'))

df_eu_volheat = pd.DataFrame(eu_volheat)
df_eu_volheat.to_excel(os.path.join(save_dir2, f'vol_eu_2eps{i}.xlsx'))
