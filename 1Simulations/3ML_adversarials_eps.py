...
epsilonvarHP8, = ax12.plot(time, varHP8_sampled_eps_mean, label=f'Humans and pigeon - 8 options', color="#ddae48",linewidth=1)
ax12.fill_between(time, varHP8_sampled_eps_mean - varHP8_sampled_eps_ste, varHP8_sampled_eps_mean + varHP8_sampled_eps_ste, color='#ddae48', alpha=0.2)

epsilonvarHP4, = ax12.plot(time, varHP4_sampled_eps_mean, label=f'Humans and pigeon - 4 options', color="#88661E",linewidth=1)
ax12.fill_between(time, varHP4_sampled_eps_mean - varHP4_sampled_eps_ste, varHP4_sampled_eps_mean + varHP4_sampled_eps_ste, color='#88661E', alpha=0.2)

epsilonvarHP2, = ax12.plot(time, varHP2_sampled_eps_mean, label=f'Humans and pigeon - 2 options', color="#493710",linewidth=1)
ax12.fill_between(time, varHP2_sampled_eps_mean - varHP2_sampled_eps_ste, varHP2_sampled_eps_mean + varHP2_sampled_eps_ste, color='#493710', alpha=0.2)
