...
save_dir = os.path.join(script_dir , 'output_9models/M2')


M2sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc'])
...
M2BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                     'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M2toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M2toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M2toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M2toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M2toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M2toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M2toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M2toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M2toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M2toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M2toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M2toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M2toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M2toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M2toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M2BIC_all.csv')
M2BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2sampled.csv')
M2sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM1.csv')
M2toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM2.csv')
M2toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM31.csv')
M2toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM32.csv')
M2toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM41.csv')
M2toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM42.csv')
M2toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM5.csv')
M2toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM61.csv')
M2toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM62.csv')
M2toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM71.csv')
M2toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM72.csv')
M2toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM81.csv')
M2toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM82.csv')
M2toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M2toM91.csv')
M2toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M2toM92.csv')
M2toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M2_HaS1var_modelfit.csv") 
...
line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "uc": true_uc}
with open("M2/M2sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "uc"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 2
k, r, rand, Q_k_stored, delta_stored = RW_eps_lr_uc_adversarial(eps=true_eps, lr=true_lr, uc=true_uc, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M2/M2toM1.csv", 'a') as f_object:
...
with open("M2/M2toM2.csv", 'a') as f_object:
...
with open("M2/M2toM31.csv", 'a') as f_object:
...
with open("M2/M2toM32.csv", 'a') as f_object:
...
with open("M2/M2toM41.csv", 'a') as f_object:
...
with open("M2/M2toM42.csv", 'a') as f_object:
...
with open("M2/M2toM5.csv", 'a') as f_object:
...
with open("M2/M2toM71.csv", 'a') as f_object:
...
with open("M2/M2toM72.csv", 'a') as f_object:
