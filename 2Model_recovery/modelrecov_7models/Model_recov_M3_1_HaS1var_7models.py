...
save_dir = os.path.join(script_dir , 'output_9models/M3_1')


M31sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr'])
...
M31BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                      'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M31toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M31toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M31toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M31toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M31toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M31toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M31toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M31toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M31toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M31toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M31toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M31toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M31toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M31toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M31toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M31BIC_all.csv')
M31BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31sampled.csv')
M31sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM1.csv')
M31toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM2.csv')
M31toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM31.csv')
M31toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM32.csv')
M31toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM41.csv')
M31toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM42.csv')
M31toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM5.csv')
M31toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM61.csv')
M31toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM62.csv')
M31toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM71.csv')
M31toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM72.csv')
M31toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM81.csv')
M31toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM82.csv')
M31toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M31toM91.csv')
M31toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M31toM92.csv')
M31toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M3_1_HaS1var_modelfit.csv") 
...
line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "gamr": true_gamr}
with open("M3_1/M31sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "gamr"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 1
k, r, rand, Q_k_stored, delta_stored = RW_eps_lr_gamr_adversarial(eps=true_eps, lr=true_lr, gamr=true_gamr, buffer=buffer, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M3_1/M31toM1.csv", 'a') as f_object:
...
with open("M3_1/M31toM2.csv", 'a') as f_object:
...
with open("M3_1/M31toM31.csv", 'a') as f_object:
...
with open("M3_1/M31toM32.csv", 'a') as f_object:
...
with open("M3_1/M31toM41.csv", 'a') as f_object:
...
with open("M3_1/M31toM42.csv", 'a') as f_object:
...
with open("M3_1/M31toM5.csv", 'a') as f_object:
...
with open("M3_1/M31toM71.csv", 'a') as f_object:
...
with open("M3_1/M31toM72.csv", 'a') as f_object:
