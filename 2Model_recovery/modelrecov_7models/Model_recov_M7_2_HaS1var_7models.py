...
save_dir = os.path.join(script_dir , 'output_9models/M7_2')


M72sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr'])
...
M72BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                      'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M72toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M72toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M72toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M72toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M72toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M72toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M72toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M72toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M72toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M72toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M72toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M72toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M72toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M72toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M72toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M72BIC_all.csv')
M72BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72sampled.csv')
M72sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM1.csv')
M72toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM2.csv')
M72toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM31.csv')
M72toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM32.csv')
M72toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM41.csv')
M72toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM42.csv')
M72toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM5.csv')
M72toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM61.csv')
M72toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM62.csv')
M72toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM71.csv')
M72toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM72.csv')
M72toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM81.csv')
M72toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM82.csv')
M72toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M72toM91.csv')
M72toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M72toM92.csv')
M72toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M7_2_HaS1var_modelfit.csv")  
...
gamnr_min = df["gamnr"].min()
gamnr_max = df["gamnr"].max()


gamnr_min = 0.1 #no use for recovery if gamr is zero, it will be the same as eps-lr model
w_min = 0.1
...
true_gamnr = random.uniform(gamnr_min, 1-true_eps)
...
true_w = random_row["w"]
true_gamnr = random_row["gamnr"]

'''

line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "uc": true_uc, "ucs": true_ucs, "w": true_w, "gamnr": true_gamnr}
with open("M7_2/M72sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "uc", "ucs", "w", "gamnr"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 1
k, r, rand, Q_k_stored, delta_stored, S_k_stored = RW_eps_lr_uc_ucs_gamnr_adversarial(eps=true_eps, lr=true_lr, uc=true_uc, ucs=true_ucs, w=true_w, gamnr=true_gamnr, buffer=buffer, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M7_2/M72toM1.csv", 'a') as f_object:
...
with open("M7_2/M72toM2.csv", 'a') as f_object:
...
with open("M7_2/M72toM31.csv", 'a') as f_object:
...
with open("M7_2/M72toM32.csv", 'a') as f_object:
...
with open("M7_2/M72toM41.csv", 'a') as f_object:
...
with open("M7_2/M72toM42.csv", 'a') as f_object:
...
with open("M7_2/M72toM5.csv", 'a') as f_object:
...
with open("M7_2/M72toM71.csv", 'a') as f_object:
...
with open("M7_2/M72toM72.csv", 'a') as f_object:
