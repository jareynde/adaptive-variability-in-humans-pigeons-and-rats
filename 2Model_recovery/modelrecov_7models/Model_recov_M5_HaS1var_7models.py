...
save_dir = os.path.join(script_dir , 'output_9models/M5')


M5sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w'])
...
M5BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                     'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M5toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M5toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M5toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M5toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M5toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M5toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M5toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M5toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M5toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M5toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M5toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M5toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M5toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M5toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M5toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M5BIC_all.csv')
M5BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5sampled.csv')
M5sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM1.csv')
M5toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM2.csv')
M5toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM31.csv')
M5toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM32.csv')
M5toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM41.csv')
M5toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM42.csv')
M5toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM5.csv')
M5toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM61.csv')
M5toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM62.csv')
M5toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM71.csv')
M5toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM72.csv')
M5toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM81.csv')
M5toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM82.csv')
M5toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M5toM91.csv')
M5toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M5toM92.csv')
M5toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M5_HaS1var_modelfit.csv")  
...
line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "uc": true_uc, "ucs": true_ucs, "w": true_w}
with open("M5/M5sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "uc", "ucs", "w"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 1
k, r, rand, Q_k_stored, delta_stored, S_k_stored = RW_eps_lr_uc_ucs_adversarial(eps=true_eps, lr=true_lr, uc=true_uc, ucs=true_ucs, w=true_w, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M5/M5toM1.csv", 'a') as f_object:
...
with open("M5/M5toM2.csv", 'a') as f_object:
...
with open("M5/M5toM31.csv", 'a') as f_object:
...
with open("M5/M5toM32.csv", 'a') as f_object:
...
with open("M5/M5toM41.csv", 'a') as f_object:
...
with open("M5/M5toM42.csv", 'a') as f_object:
...
with open("M5/M5toM5.csv", 'a') as f_object:
...
with open("M5/M5toM71.csv", 'a') as f_object:
...
with open("M5/M5toM72.csv", 'a') as f_object:
