...
save_dir = os.path.join(script_dir , 'output_9models/M4_2')


M42sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr'])
...
M42BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                      'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M42toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M42toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M42toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M42toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M42toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M42toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M42toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M42toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M42toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M42toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M42toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M42toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M42toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M42toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M42toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M42BIC_all.csv')
M42BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42sampled.csv')
M42sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM1.csv')
M42toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM2.csv')
M42toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM31.csv')
M42toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM32.csv')
M42toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM41.csv')
M42toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM42.csv')
M42toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM5.csv')
M42toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM61.csv')
M42toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM62.csv')
M42toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM71.csv')
M42toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM72.csv')
M42toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM81.csv')
M42toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM82.csv')
M42toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M42toM91.csv')
M42toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M42toM92.csv')
M42toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M4_2_HaS1var_modelfit.csv")  
...
gamnr_min = 0.1 #no use for recovery if gamnr is zero, it will be the same as eps-lr model
...
'''
line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "uc": true_uc, "gamnr": true_gamnr}
with open("M4_2/M42sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "uc", "gamnr"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 1
k, r, rand, Q_k_stored, delta_stored = RW_eps_lr_uc_gamnr_adversarial(eps=true_eps, lr=true_lr, uc=true_uc, gamnr=true_gamnr, buffer=buffer, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M4_2/M42toM1.csv", 'a') as f_object:
...
with open("M4_2/M42toM2.csv", 'a') as f_object:
...
with open("M4_2/M42toM31.csv", 'a') as f_object:
...
with open("M4_2/M42toM32.csv", 'a') as f_object:
...
with open("M4_2/M42toM41.csv", 'a') as f_object:
...
with open("M4_2/M42toM42.csv", 'a') as f_object:
...
with open("M4_2/M42toM5.csv", 'a') as f_object:
...
with open("M4_2/M42toM71.csv", 'a') as f_object:
...
with open("M4_2/M42toM72.csv", 'a') as f_object:
