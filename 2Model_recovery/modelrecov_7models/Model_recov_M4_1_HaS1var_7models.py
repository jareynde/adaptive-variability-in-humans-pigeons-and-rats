...
save_dir = os.path.join(script_dir , 'output_9models/M4_1')


M41sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr'])
...
M41BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                      'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M41toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M41toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M41toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M41toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M41toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M41toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M41toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M41toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M41toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M41toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M41toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M41toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M41toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M41toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M41toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M41BIC_all.csv')
M41BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41sampled.csv')
M41sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM1.csv')
M41toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM2.csv')
M41toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM31.csv')
M41toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM32.csv')
M41toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM41.csv')
M41toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM42.csv')
M41toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM5.csv')
M41toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM61.csv')
M41toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM62.csv')
M41toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM71.csv')
M41toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM72.csv')
M41toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM81.csv')
M41toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM82.csv')
M41toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M41toM91.csv')
M41toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M41toM92.csv')
M41toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M4_1_HaS1var_modelfit.csv")  
...
line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "uc": true_uc, "gamr": true_gamr}
with open("M4_1/M41sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "uc", "gamr"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 1
k, r, rand, Q_k_stored, delta_stored = RW_eps_lr_uc_gamr_adversarial(eps=true_eps, lr=true_lr, uc=true_uc, gamr=true_gamr, buffer=buffer, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M4_1/M41toM1.csv", 'a') as f_object:
...
with open("M4_1/M41toM2.csv", 'a') as f_object:
...
with open("M4_1/M41toM31.csv", 'a') as f_object:
...
with open("M4_1/M41toM32.csv", 'a') as f_object:
...
with open("M4_1/M41toM41.csv", 'a') as f_object:
...
with open("M4_1/M41toM42.csv", 'a') as f_object:
...
with open("M4_1/M41toM5.csv", 'a') as f_object:
...
with open("M4_1/M41toM71.csv", 'a') as f_object:
...
with open("M4_1/M41toM72.csv", 'a') as f_object:
