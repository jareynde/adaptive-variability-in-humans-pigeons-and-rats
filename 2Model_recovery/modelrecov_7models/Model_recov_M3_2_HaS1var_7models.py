...
save_dir = os.path.join(script_dir , 'output_9models/M3_2')


M32sampled = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr'])
...
M32BIC_all = pd.DataFrame(index=range(0, 1), columns=['sim', 
                                                      'M1eps-lr', 
                                                     'M2eps-lr-uc', 
...
M32toM1 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'negLL', 'BIC'])
M32toM2 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'negLL', 'BIC'])

M32toM31 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'negLL', 'BIC'])
M32toM32 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'negLL', 'BIC'])

M32toM41 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'negLL', 'BIC'])
M32toM42 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'negLL', 'BIC'])

M32toM5 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gam', 'negLL', 'BIC'])

M32toM61 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamr', 'gamsr', 'negLL', 'BIC'])
M32toM62 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M32toM71 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'negLL', 'BIC'])
M32toM72 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'negLL', 'BIC'])

M32toM81 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamr', 'gamsr', 'negLL', 'BIC'])
M32toM82 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'gamnr', 'gamsnr', 'negLL', 'BIC'])

M32toM91 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamr', 'gamsr', 'negLL', 'BIC'])
M32toM92 = pd.DataFrame(index=range(0, 1), columns=['sim', 'eps', 'lr', 'uc', 'ucs', 'w', 'gamnr', 'gamsnr', 'negLL', 'BIC'])



title_excel = os.path.join(save_dir, f'M32BIC_all.csv')
M32BIC_all.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32sampled.csv')
M32sampled.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM1.csv')
M32toM1.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM2.csv')
M32toM2.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM31.csv')
M32toM31.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM32.csv')
M32toM32.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM41.csv')
M32toM41.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM42.csv')
M32toM42.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM5.csv')
M32toM5.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM61.csv')
M32toM61.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM62.csv')
M32toM62.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM71.csv')
M32toM71.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM72.csv')
M32toM72.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM81.csv')
M32toM81.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM82.csv')
M32toM82.to_csv(title_excel, index=False)

title_excel = os.path.join(save_dir, f'M32toM91.csv')
M32toM91.to_csv(title_excel, index=False)
title_excel = os.path.join(save_dir, f'M32toM92.csv')
M32toM92.to_csv(title_excel, index=False)
...
df = pd.read_csv("parameter_values/M3_2_HaS1var_modelfit.csv") 
...
line_to_write = {"sim": sim, "eps": true_eps, "lr": true_lr, "gamnr": true_gamnr}
with open("M3_2/M32sampled.csv", 'a') as f_object:
    field_names = ["sim", "eps", "lr", "gamnr"]
    dictwriter_object = DictWriter(f_object, fieldnames = field_names)
    dictwriter_object.writerow(line_to_write)
    f_object.close()

#simulate data from model 1
k, r, rand, Q_k_stored, delta_stored = RW_eps_lr_gamnr_adversarial(eps=true_eps, lr=true_lr, gamnr=true_gamnr, buffer=buffer, T=T, Q_int=Q_int)
k = k.astype(int)
r = r.astype(int)
...
with open("M3_2/M32toM1.csv", 'a') as f_object:
...
with open("M3_2/M32toM2.csv", 'a') as f_object:
...
with open("M3_2/M32toM31.csv", 'a') as f_object:
...
with open("M3_2/M32toM32.csv", 'a') as f_object:
...
with open("M3_2/M32toM41.csv", 'a') as f_object:
...
with open("M3_2/M32toM42.csv", 'a') as f_object:
...
with open("M3_2/M32toM5.csv", 'a') as f_object:
...
with open("M3_2/M32toM71.csv", 'a') as f_object:
...
with open("M3_2/M32toM72.csv", 'a') as f_object:
