...
BIC1 = np.zeros([amount,4])
BIC2 = np.zeros([amount,4])
BIC3 = np.zeros([amount,4])
...
### sim model 1: eps, alpha, lambda ###
    ...
    with open("HP2_eps_alpha_lambda.csv", 'a') as f_object:
...
### sim model 2: eps, alpha ###
    ...
    with open("HP2_eps_alpha.csv", 'a') as f_object:
        field_names = ["sim", "eps-alpha-lambda", "eps-alpha", "eps-lambda", "eps"]
        dictwriter_object = DictWriter(f_object, fieldnames = field_names)
        dictwriter_object.writerow(line_to_write)
        f_object.close()
...
### sim model 3: eps, alpha ###
    ...
    with open("HP2_eps_lambda.csv", 'a') as f_object:
        field_names = ["sim", "eps-alpha-lambda", "eps-alpha", "eps-lambda", "eps"]
        dictwriter_object = DictWriter(f_object, fieldnames = field_names)
        dictwriter_object.writerow(line_to_write)
        f_object.close()
...
### sim model 4: eps ###
    ...
    with open("HP2_eps.csv", 'a') as f_object:
        field_names = ["sim", "eps-alpha-lambda", "eps-alpha", "eps-lambda", "eps"]
        dictwriter_object = DictWriter(f_object, fieldnames = field_names)
        dictwriter_object.writerow(line_to_write)
        f_object.close()
