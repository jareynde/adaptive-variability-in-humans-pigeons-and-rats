...
for strategy in strategies:
    ...
    for count in range(recov_amount):
        ...
        true_unchosen = np.random.uniform(-3, 3)

        print('unchosen', true_unchosen)
    ...
    title_excel = os.path.join(save_dir, f'rat_results_eps_lr_lambda.xlsx')
    ...
    title_excel = os.path.join(save_dir, f'rat_correlation_values.xlsx')
    ...
    fig_name1 = os.path.join(save_dir, f'rat_true-vs-recov_eps_lr_lambda')
    plt.show()
...
for strategy in strategies:
    ...
    title_excel = os.path.join(save_dir, f'HP8_results_eps_lr_lambda.xlsx')
    results.to_excel(title_excel, index=False)
    results = pd.read_excel(title_excel)
    ...
    title_excel = os.path.join(save_dir, f'HP8_correlation_values.xlsx')
    df = pd.DataFrame(data=store_correlations)
    df.to_excel(title_excel, index=False)
    ...
    ax3.set_xlabel('true lambda')
    ax3.set_ylabel('recovered lambda')
    fig_name1 = os.path.join(save_dir, f'HP8_true-vs-recov_eps_lr_lambda')
    plt.show()
    plt.savefig(fig_name1)
...
for strategy in strategies:
    ...
    title_excel = os.path.join(save_dir, f'HP4_results_eps_lr_lambda.xlsx')
    results.to_excel(title_excel, index=False)
    results = pd.read_excel(title_excel)
    ...
    title_excel = os.path.join(save_dir, f'HP4_correlation_values.xlsx')
    df = pd.DataFrame(data=store_correlations)
    df.to_excel(title_excel, index=False)
    ...
    ax3.set_xlabel('true lambda')
    ax3.set_ylabel('recovered lambda')
    fig_name1 = os.path.join(save_dir, f'HP4_true-vs-recov_eps_lr_lambda')
    plt.show()
    plt.savefig(fig_name1)
...
for strategy in strategies:
    ...
    title_excel = os.path.join(save_dir, f'HP2_results_eps_lr_lambda.xlsx')
    results.to_excel(title_excel, index=False)
    results = pd.read_excel(title_excel)
    ...
    title_excel = os.path.join(save_dir, f'HP2_correlation_values.xlsx')
    df = pd.DataFrame(data=store_correlations)
    df.to_excel(title_excel, index=False)
    ...
    ax3.set_xlabel('true lambda')
    ax3.set_ylabel('recovered lambda')
    fig_name1 = os.path.join(save_dir, f'HP2_true-vs-recov_eps_lr_lambda')
    plt.show()
    plt.savefig(fig_name1)